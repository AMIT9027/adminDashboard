...
import { AddCoursesForm, AddCoursesWrapper, Description, Heading, HeadingWrapper, NameInput, NameLabel, NameWrapper, Options, PriceMentorWrapper, PriceWrapper, SelectMentor, Submit } from '../../styles/AddCourses'
    ...
    <Card title = "Add Courses">
        <AddCoursesForm onSubmit={handleSubmit(onSubmitHandler)}>
            <NameWrapper>
                ...
                <NameInput {...register("name")} type = "text" placeholder = "Enter your name" />
            ...
            <PriceMentorWrapper>
                <PriceWrapper>
                    ...
                    <NameInput {...register("price")} type = "text" placeholder = "Price" />
                    <ErrorMessage>{errors.price?.message}</ErrorMessage>
                </PriceWrapper>
                <PriceWrapper>
                <NameLabel>Mentor</NameLabel>
                <SelectMentor name = "mentors" {...register("mentor")}>
                    <Options disabled selected>Select mentor</Options>
